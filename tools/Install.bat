@echo off
REM
REM summary: Installation script for the OOTyW_de-CH software package.
REM 
...
set _user=%USERPROFILE%\%_OpenOffice4_Userprofile%
set _ext=OOTyW-A_de-CH-%_release%.oxt
...
echo -----------------------------------------------------------------
echo #
echo # Installation of OOTyW_de-CH v%_release% finished.
echo #
echo -----------------------------------------------------------------
pause
