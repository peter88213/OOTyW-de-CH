rem @echo off
REM cs.bat
REM summary: Collects everything for a OOTyW_de-CH release
...
set _source=%_root%\
set _target=%_root%\build\OOTyW_de-CH_v%_release%
...
echo # OOTyW_de-CH - OOTyW language pack (de-CH) v%_release%>%_target%\README.txt
...
set _file=%_root%\oxt\OOTyW_de-CH-%_release%.oxt
set _dest=%_target%\program\
call :copyFile

set _file=%_root%\oxt\OOTyW_de-CH-A-%_release%.oxt
set _dest=%_target%\program\
call :copyFile

set _file=%_root%\oxt\OOTyW_de-CH-L-%_release%.oxt
set _dest=%_target%\program\
call :copyFile
