@echo off
REM
REM summary: Removes the OOTyW_de-CH software package.
REM 
REM author: Peter Triesberger
REM see: https://github.com/peter88213/OOTyW_de-CH
REM license: The MIT License (https://opensource.org/licenses/mit-license.php)
REM copyright: (c) 2019, Peter Triesberger
REM 
REM note: This script is to be executed manually.
REM 
REM precondition: OOTyW_de-CH is installed.
REM precondition: OpenOffice.org 3.x or Apache OpenOffice 4.x is installed.
REM postcondition: Previously auto-installed items of OOTyW_de-CH are removed.
...
echo -----------------------------------------------------------------
echo OOTyW_de-CH (OpenOffice typography tools for yWriter users) v%_release%
...
set _ext=OOTyW_de-CH-A-%_release%.oxt
...
set _ext=OOTyW_de-CH-%_release%.oxt
...
set _ext=OOTyW_de-CH-L-%_release%.oxt
...
echo -----------------------------------------------------------------
echo #
echo # OOTyW_de-CH v%_release% is removed from your PC.
echo #
echo -----------------------------------------------------------------
pause
